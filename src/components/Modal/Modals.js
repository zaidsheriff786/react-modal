          ...
          <Portal key={index} id={modal.id}>
            ...
            >
              <div>
                ...
                <p>
                  Treebo derives its name from "Bo Tree", the fig tree under
                  which Gautam Buddha attained enlightenment. The fig tree
                  family - banyan, peepal among others - has inspired not just
                  our name but also what we do.
                </p>
                <p>
